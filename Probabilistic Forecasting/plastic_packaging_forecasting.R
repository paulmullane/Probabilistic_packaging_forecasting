...
# plot
plot(y=austria$ppw, x=austria$Year, type='b',
     xlab='Year', ylab='%', main='Austria Plastic Packaging Recycling',
     xlim=c(1997, 2030))
...
# plot
plot(y=belgium$ppw, x=belgium$Year, type='b',
     xlab='Year', ylab='%', main='Belgium Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(belgium$ppw), max(belgium_median_pis$upper_pi)))
...
# plot
plot(y=denmark$ppw, x=denmark$Year, type='b',
     xlab='Year', ylab='%', main='Denmark Plastic Packaging Recycling',
     xlim=c(1997, 2030))
...
# plot
plot(y=finland$ppw, x=finland$Year, type='b',
     xlab='Year', ylab='%', main='Finland Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(finland$ppw), max(finland_median_pis$upper_pi)))
...
# plot
plot(y=france$ppw, x=france$Year, type='b',
     xlab='Year', ylab='%', main='France Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(france$ppw), max(france_median_pis$upper_pi)))
...
# plot
plot(y=germany$ppw, x=germany$Year, type='b',
     xlab='Year', ylab='%', main='Germany Plastic Packaging Recycling',
     xlim=c(1997, 2030))
...
# plot
plot(y=ireland$ppw, x=ireland$Year, type='b',
     xlab='Year', ylab='%', main='Ireland Plastic Packaging Recycling',
     xlim=c(1997, 2030))
...
# plot
plot(y=italy$ppw, x=italy$Year, type='b',
     xlab='Year', ylab='%', main='Italy Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(italy$ppw), max(italy_median_pis$upper_pi)))
...
# plot
plot(y=luxembourg$ppw, x=luxembourg$Year, type='b',
     xlab='Year', ylab='%', main='Luxembourg Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(luxembourg$ppw), max(luxembourg_median_pis$upper_pi)))
...
plot(y=netherlands$ppw, x=netherlands$Year, type='b',
     xlab='Year', ylab='%', main='Netherlands Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(netherlands$ppw), max(netherlands_median_pis$upper_pi)))
...
plot(y=portugal$ppw, x=portugal$Year, type='b',
     xlab='Year', ylab='%', main='Portugal Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(portugal$ppw), max(portugal_median_pis$upper_pi)))
...
plot(y=spain$ppw, x=spain$Year, type='b',
     xlab='Year', ylab='%', main='Spain Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(spain$ppw), max(spain_median_pis$upper_pi)))
...
plot(y=sweden$ppw, x=sweden$Year, type='b',
     xlab='Year', ylab='%', main='Sweden Plastic Packaging Recycling',
     xlim=c(1997, 2030))
...
#austria
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Austria
...
#belgium
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Belgium
...
#denmark
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Denmark
...
#finland
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Finland
...
#france
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$France
...
#germany
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Germany
...
#ireland
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Ireland
...
#italy
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Italy
...
#luxembourg
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Luxembourg
...
#netherlands
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Netherlands
...
#portugal
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Portugal
...
#spain
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Spain
...
#sweden
plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Sweden
...
#plot----
pdf("plastic_forecasts.pdf", width=12, height=16)
par(mfrow=c(7, 2),
    mar=c(4, 5, 2, 1),
    cex.main=2,
    cex.lab=1.5,
...
plot(y=austria$ppw, x=austria$Year, type='b',
     xlab='Year', ylab='%', main='Austria Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(austria$ppw), max(austria_median_pis$upper_pi)))
lines(y=austria_median_pis$median_forecast, x=austria_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Austria, col='red', pch=17)
polygon(c(austria_median_pis$year, rev(austria_median_pis$year)),
        c(austria_median_pis$upper_pi, rev(austria_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=belgium$ppw, x=belgium$Year, type='b',
     ...
     xlim=c(1997, 2030), ylim=c(min(belgium$ppw), max(belgium_median_pis$upper_pi)))
lines(y=belgium_median_pis$median_forecast, x=belgium_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Belgium, col='red', pch=17)
polygon(c(belgium_median_pis$year, rev(belgium_median_pis$year)),
        c(belgium_median_pis$upper_pi, rev(belgium_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=denmark$ppw, x=denmark$Year, type='b',
     xlab='Year', ylab='%', main='Denmark Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(denmark_median_pis$lower_pi), max(denmark$ppw)))
lines(y=denmark_median_pis$median_forecast, x=denmark_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Denmark, col='red', pch=17)
polygon(c(denmark_median_pis$year, rev(denmark_median_pis$year)),
        c(denmark_median_pis$upper_pi, rev(denmark_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=finland$ppw, x=finland$Year, type='b',
     ...
     xlim=c(1997, 2030), ylim=c(min(finland$ppw), max(finland_median_pis$upper_pi)))
lines(y=finland_median_pis$median_forecast, x=finland_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Finland, col='red', pch=17)
polygon(c(finland_median_pis$year, rev(finland_median_pis$year)),
        c(finland_median_pis$upper_pi, rev(finland_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=france$ppw, x=france$Year, type='b',
     ...
     xlim=c(1997, 2030), ylim=c(min(france$ppw), max(france_median_pis$upper_pi)))
lines(y=france_median_pis$median_forecast, x=france_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$France, col='red', pch=17)
polygon(c(france_median_pis$year, rev(france_median_pis$year)),
        c(france_median_pis$upper_pi, rev(france_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=germany$ppw, x=germany$Year, type='b',
     xlab='Year', ylab='%', main='Germany Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(germany$ppw), max(germany$ppw)))
lines(y=germany_median_pis$median_forecast, x=germany_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Germany, col='red', pch=17)
polygon(c(germany_median_pis$year, rev(germany_median_pis$year)),
        c(germany_median_pis$upper_pi, rev(germany_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=ireland$ppw, x=ireland$Year, type='b',
     xlab='Year', ylab='%', main='Ireland Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(ireland$ppw), max(ireland$ppw)))
lines(y=ireland_median_pis$median_forecast, x=ireland_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Ireland, col='red', pch=17)
polygon(c(ireland_median_pis$year, rev(ireland_median_pis$year)),
        c(ireland_median_pis$upper_pi, rev(ireland_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=italy$ppw, x=italy$Year, type='b',
     ...
     xlim=c(1997, 2030), ylim=c(min(italy$ppw), max(italy_median_pis$upper_pi)))
lines(y=italy_median_pis$median_forecast, x=italy_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Italy, col='red', pch=17)
polygon(c(italy_median_pis$year, rev(italy_median_pis$year)),
        c(italy_median_pis$upper_pi, rev(italy_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=luxembourg$ppw, x=luxembourg$Year, type='b',
     ...
     xlim=c(1997, 2030), ylim=c(min(luxembourg$ppw), max(luxembourg_median_pis$upper_pi)))
lines(y=luxembourg_median_pis$median_forecast, x=luxembourg_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Luxembourg, col='red', pch=17)
polygon(c(luxembourg_median_pis$year, rev(luxembourg_median_pis$year)),
        c(luxembourg_median_pis$upper_pi, rev(luxembourg_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=netherlands$ppw, x=netherlands$Year, type='b',
     xlab='Year', ylab='%', main='Netherlands Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(netherlands$ppw), max(e=netherlands_median_pis$upper_pi)))
lines(y=netherlands_median_pis$median_forecast, x=netherlands_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Netherlands, col='red', pch=17)
polygon(c(netherlands_median_pis$year, rev(netherlands_median_pis$year)),
        c(netherlands_median_pis$upper_pi, rev(netherlands_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=portugal$ppw, x=portugal$Year, type='b',
     ...
     xlim=c(1997, 2030), ylim=c(min(portugal$ppw), max(portugal_median_pis$upper_pi)))
lines(y=portugal_median_pis$median_forecast, x=portugal_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Portugal, col='red', pch=17)
polygon(c(portugal_median_pis$year, rev(portugal_median_pis$year)),
        c(portugal_median_pis$upper_pi, rev(portugal_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=spain$ppw, x=spain$Year, type='b',
     ...
     xlim=c(1997, 2030), ylim=c(min(spain$ppw), max(spain_median_pis$upper_pi)))
lines(y=spain_median_pis$median_forecast, x=spain_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Spain, col='red', pch=17)
polygon(c(spain_median_pis$year, rev(spain_median_pis$year)),
        c(spain_median_pis$upper_pi, rev(spain_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
...
plot(y=sweden$ppw, x=sweden$Year, type='b',
     xlab='Year', ylab='%', main='Sweden Plastic Packaging Recycling',
     xlim=c(1997, 2030), ylim=c(min(sweden_median_pis$lower_pi), max(sweden$ppw)))
lines(y=sweden_median_pis$median_forecast, x=sweden_median_pis$year, type='b', col='blue')
points(x=2023, y=plastic_packaging_waste[plastic_packaging_waste$TIME=='2023',]$Sweden, col='red', pch=17)
polygon(c(sweden_median_pis$year, rev(sweden_median_pis$year)),
        c(sweden_median_pis$upper_pi, rev(sweden_median_pis$lower_pi)),
        col=rgb(0, 0, 1, 0.2), border=NA)
#legend('topleft', legend=c('Observed', 'Median Forecast', '95% PI'),
