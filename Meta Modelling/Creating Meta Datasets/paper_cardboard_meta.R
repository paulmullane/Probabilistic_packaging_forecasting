...
#loading in the data----
#packaging data
pc_packaging_waste <- read_excel("C:/Users/20229798/OneDrive - University of Limerick/Desktop/Packaging waste forecasting/Packaging Data/Paper_cardboard_packaging_waste.xlsx")
