...
glass_meta <- data.frame(country=c("Austria", "Belgium", "Denmark", "Finland", 
                                   "France", "Germany","Ireland", "Italy", "Luxembourg", 
                                   "Netherlands", "Portugal", "Spain", "Sweden"),
                         stream="Glass",
                         model=c("BRR", "SVM", "SVM", "SVM", "BRR", "BRR","SVM", 
                                 "BRR", "SVM", "SVM", "SVM", "SVM", "SVM"),
                         n_covariates=c(1, 1, 1, 1, 1, 1,1, 4, 4, 1, 1, 6, 4)
)

#2023 forcast error & absolute forecast error----
glass_meta$forecast_error_2023 <- c(glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Austria-austria_median_pis[austria_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Belgium-belgium_median_pis[belgium_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Denmark-denmark_median_pis[denmark_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Finland-finland_median_pis[finland_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$France-france_median_pis[france_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Germany-germany_median_pis[germany_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Ireland-ireland_median_pis[ireland_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Italy-italy_median_pis[italy_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Luxembourg-luxembourg_median_pis[luxembourg_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Netherlands-netherlands_median_pis[netherlands_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Portugal-portugal_median_pis[portugal_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Spain-spain_median_pis[spain_median_pis$year=='2023',]$median_forecast,
  glass_packaging_waste[glass_packaging_waste$TIME=='2023',]$Sweden-sweden_median_pis[sweden_median_pis$year=='2023',]$median_forecast
)

glass_meta$abs_forecast_error_2023 <- abs(glass_meta$forecast_error_2023)

#PI width----
glass_meta$pi_width_2023 <- c(austria_median_pis[austria_median_pis$year=='2023',]$upper_pi-austria_median_pis[austria_median_pis$year=='2023',]$lower_pi,
...
glass_meta$train_sd <- c(sd(austria[austria$Year<=2017,]$gpw),
                         sd(belgium[belgium$Year<=2017,]$gpw),
                         sd(denmark[denmark$Year<=2017,]$gpw),
                         sd(finland[finland$Year<=2017,]$gpw),
                         sd(france[france$Year<=2017,]$gpw),
                         sd(germany[germany$Year<=2017,]$gpw),
                         sd(ireland[ireland$Year<=2017,]$gpw),
                         sd(italy[italy$Year<=2017,]$gpw),
                         sd(luxembourg[luxembourg$Year<=2017,]$gpw),
                         sd(netherlands[netherlands$Year<=2017,]$gpw),
                         sd(portugal[portugal$Year<=2017,]$gpw),
                         sd(spain[spain$Year<=2017,]$gpw),
                         sd(sweden[sweden$Year<=2017,]$gpw)
)

glass_meta$test_sd <- c(sd(austria[austria$Year>=2018,]$gpw),
                        sd(belgium[belgium$Year>=2018,]$gpw),
                        sd(denmark[denmark$Year>=2018,]$gpw),
                        sd(finland[finland$Year>=2018,]$gpw),
                        sd(france[france$Year>=2018,]$gpw),
                        sd(germany[germany$Year>=2018,]$gpw),
                        sd(ireland[ireland$Year>=2018,]$gpw),
                        sd(italy[italy$Year>=2018,]$gpw),
                        sd(luxembourg[luxembourg$Year>=2018,]$gpw),
                        sd(netherlands[netherlands$Year>=2018,]$gpw),
                        sd(portugal[portugal$Year>=2018,]$gpw),
                        sd(spain[spain$Year>=2018,]$gpw),
                        sd(sweden[sweden$Year>=2018,]$gpw)
)

glass_meta$sd_ratio <- glass_meta$test_sd/glass_meta$train_sd

#trend of training set, trend of whole series, their difference, binary change of trend direction----
trend_slope <- function(df, year_col = "Year", y_col = "gpw"){
  coef(lm(df[[y_col]] ~ df[[year_col]]))[2]
}

glass_meta$slope_full <- c(trend_slope(austria), trend_slope(belgium),
...
glass_meta$slope_diff <- glass_meta$slope_full - glass_meta$slope_train


glass_meta$trend_reversal <- as.integer(sign(glass_meta$slope_full)!=sign(glass_meta$slope_train))

#maximum and mean absolute change (Rise/fall) over the whole series----
max_abs_change <- function(df, y_col = "gpw"){
  max(abs(diff(df[[y_col]])))
}

mean_abs_change <- function(df, y_col = "gpw"){
  mean(abs(diff(df[[y_col]])))
}

glass_meta$max_abs_change <- c(max_abs_change(austria), max_abs_change(belgium),
...
glass_meta$mean_abs_change <- c(mean_abs_change(austria), mean_abs_change(belgium),
...
write.csv(glass_meta, file='glass_meta_dataset.csv')
